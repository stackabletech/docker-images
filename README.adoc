...
To mirror a third-party image into our OCI registry, please use our https://github.com/stackabletech/docker-images/actions/workflows/mirror.yaml[Github Workflow for mirroring images].
This will mirror the image into oci.stackable.tech and also sign it.